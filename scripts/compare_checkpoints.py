...
parser.add_argument(
    '-top_p', type=float, default=0.9, help='Nucleus sampling threshold (default: 0.9)'
)
parser.add_argument(
    '-save', type=str, default=None, help='Save comparison to file (default: print to stdout)'
)
