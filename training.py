...
parser = argparse.ArgumentParser(prog='Training Model', description='This model is for training the GPT chatbot')
...
def get_random_chunk(split):
    ''' Memory map for using small snippets of text from a single gile of any size '''
